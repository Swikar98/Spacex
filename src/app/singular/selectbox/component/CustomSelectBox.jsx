  ...
  return (
    ...
    <div className="bg-gray-100 flex flex-col justify-center items-center w-fit relative z-30">
      <div
        ...
        className="flex flex-row justify-between items-center bg-white w-48 my-2 cursor-pointer p-2 rounded-lg"
      >
    ...
    <div onClick={() => setOpen(false)}
     className={`bg-gray-100 fixed opacity-50 z-0 inset-0 ${open ? "block" : "hidden"}`}></div>
    </>
  );
};
